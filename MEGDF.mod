...
parameters    
	...
	gamma 	            ${gamma}$		(long_name='Tasa bruta de crecimiento del PIB por persona en edad de trabajar -15,64- años-')
    	delta_1             ${delta_1}$		(long_name='Tasa de depreciacion del capital en sector 1')
	delta_2	            ${delta_2}$		(long_name='Tasa de depreciacion del capital en sector 2')
	delta_3             ${delta_3}$		(long_name='Tasa de depreciacion del capital en sector 3')
	delta_g             ${delta_g}$		(long_name='Tasa de depreciacion de la infraestructura')
	dep           	    ${dep}$		(long_name='Relacion deuda externa total a PIB')
	dpp                 ${dpp}$		(long_name='Relacion deuda publica externa e interna total a PIB')
	...
	lambdamin           ${lambdamin}$	(long_name='Porcentaje de la no ricardiana')
	miu_c               ${miu_c}$		(long_name='Ponderacion del insumo domestico en la produccion del bien de consumo')
	miu_d               ${miu_d}$		(long_name='Ponderacion del insumo transable en la produccion de del bien domestico')
	miu_e               ${miu_e}$		(long_name='Peso de exportaciones del bien de consumo en agregado de exportaciones')
	miu_i               ${miu_i}$		(long_name='Ponderacion del insumo domestico en la produccion del bien de inversion')
	xi_1                ${xi_1}$		(long_name='Costo de ajuste de precios en sector 1')
	...
	ji_13               ${ji_13}$		(long_name='Requerimiento de insumo del sector 1 en la produccion bruta del sector 3')
	ji_21               ${ji_21}$		(long_name='Requerimiento de insumo del sector 2 en la produccion bruta del sector 1')
	ji_22               ${ji_22}$		(long_name='Requerimiento de insumo del sector 2 en la produccion bruta del sector 2')
	ji_23               ${ji_23}$		(long_name='Requerimiento de insumo del sector 2 en la produccion bruta del sector 3')
	ji_31               ${ji_31}$		(long_name='Requerimiento de insumo del sector 3 en la produccion bruta del sector 1')
	ji_32               ${ji_32}$		(long_name='Requerimiento de insumo del sector 3 en la produccion bruta del sector 2')
	ji_33               ${ji_33}$		(long_name='Requerimiento de insumo del sector 3 en la produccion bruta del sector 3')
	ji_M1               ${ji_M1}$		(long_name='Requerimiento de materias primas importadas en la produccion del sector 1')
	ji_M2               ${ji_M2}$		(long_name='Requerimiento de materias primas importadas en la produccion del sector 2')
	ji_M3               ${ji_M3}$		(long_name='Requerimiento de materias primas importadas en la produccion del sector 3')
	psi_no_1            ${psi_no_1}$	(long_name='Parametro de desutilidad del trabajo no-Ricardiano en sector 1')
	psi_no_2            ${psi_no_2}$	(long_name='Parametro de desutilidad del trabajo no-Ricardiano en sector 2')
	psi_no_3            ${psi_no_3}$	(long_name='Parametro de desutilidad del trabajo no-Ricardiano en sector 3')
	psi_o_1             ${psi_o_1}$		(long_name='Parametro de desutilidad del trabajo Ricardiano en sector 1')
	psi_o_2             ${psi_o_2}$		(long_name='Parametro de desutilidad del trabajo Ricardiano en sector 2')
	psi_o_3             ${psi_o_3}$		(long_name='Parametro de desutilidad del trabajo Ricardiano en sector 3')
	omega_c             ${omega_c}$		(long_name='Elasticidad de sustitucion de armington entre bienes domesticos e importados')
	omega_d             ${omega_d}$		(long_name='Elasticidad de sustitución entre bienes transables y no transables')
	omega_i             ${omega_i}$		(long_name='Elasticidad de sustitucion de armington entre bienes domesticos e importados')